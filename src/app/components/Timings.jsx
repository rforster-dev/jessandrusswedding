export default function Timings() {
  return (
    <div id="timings" class="story organization section-padding">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5">
            <div id="content">
              <ul class="timeline">
                ...
                <li class="event" data-date="1:30pm">
                  <h3>Cocktails and canapés</h3>
                </li>
                <li class="event" data-date="3:30pm">
                  <h3>Speeches</h3>
                </li>
                <li class="event" data-date="3:45pm">
                  <h3>Time to eat</h3>
                </li>
                <li class="event" data-date="5:45pm">
